    ...
    const steps = [
        {
            ...
            text_english: "Inviting Mr. Chhorn Ratanak to the stage to analyze the image of Metreya Buddha (Preah Ser-Ayr Metrey). Mr. Chhorn Ratanak is a National Scout of Cambodia who frequently leads and gives orders to the National Scouts of Cambodia (purity/core) at the Demonstration High School under the National Institute of Education (NIE) near the Independence Monument, Phnom Penh. Furthermore, Mr. Chhorn Ratanak is also the person who approved the removal of Huokaing Thara's name from the National Scouts of Cambodia in the middle of Grade 10. Mr. Chhorn Ratanak is known as an expert regarding ghosts, spirits, and demons. His channel focuses on discussing and analyzing images or legends related to the mysterious. The image of Metreya Buddha is an important religious concept in Buddhism, predicting that the future Buddha will arise to continue teaching the Dhamma and saving sentient beings. An analysis of this image by an expert like Mr. Chhorn Ratanak can provide perspectives on how Metreya is perceived in Khmer traditions and its connection to mystical beliefs."
        },
        {
            ...
            text_english: "Analyzing the word transformation between 'Ser-Ayr Metrey' and 'Svay Metrey': Taking the top vowel ិ (Srah I) from 'Ser-Ayr' and flipping it downward creates the subscript ្វ (Cheung Vo), turning it into 'Svay Metrey'. Reversing the process by flipping subscript ្វ upward restores it back to vowel ិ ('Ser-Ayr Metrey'). Note: The characters 'រ្យ' in 'សិអារ្យ' act as a silent modifier (similar to 'Achar' / អាចារ្យ) and are not pronounced."
        },
        {
            text_khmer: "បន្ទាប់មកអញ្ជើញ ស្វាយ មេត្រី ​ឡើងលើវេទិការ។",
            text_english: "Next, inviting Svay Metrey to the stage."
        },
        {
            ...
            text_english: "There is a question from the groom to Svay Metrey, wanting to hear directly in person: What was the reason for removing my name in the middle of Grade 10—both as a student and as a National Scout of Cambodia—even though I was his direct scout?"
        },
        {
        ...
        },
        {
            ...
            text_english: "After receiving a response from Svay Metrey, who is known as the class monitor and Scout Leader of Class A, all Casios worldwide display the explanation of the result of 1 divided by 0 without an error—as do various other AI systems—daring to divide 1 by 0 without encountering issues in interpreting the result. One perspective in interpreting the meaning of the scriptures relates to the 5th Buddha, whom many monks have been eagerly awaiting for over 3,500 years, reinterpreting it by linking it to the name Seng Visaynea, who is known as the Scout Leader of Class B instead. According to this view, Metreya Buddha does not refer to a separate individual, but is a name referring to Seng Visaynea, who is considered to be the 5th Buddha that many people believe they have been waiting for over 3,500 years. Therefore, according to this interpretation, Buddhists no longer need to wait for Metreya Buddha, as they will understand that the 5th Buddha is Seng Visaynea himself."
        },
        {
            text_khmer: "ទាក់ទងនឹងលក្ខណៈរូបរាងកាយរបស់ព្រះសិអារ្យ មេត្រី (ឬព្រះពុទ្ធទី ៥) ដែលត្រូវបានភ្ជាប់ទៅនឹង សេង វិស័យនា គឺមានទ្រង់ទ្រាយប្រកបដោយមហាបុរិសលក្ខណៈទាំង ៣២ ប្រការ។ រូបរាងកាយមានសម្បុរដូចជាមាសទិព្វ រស្មីភ្លឺថ្លាចេញពីរាងកាយ សសៃសក់រមូរស្តាំប្រកបដោយឧណ្ហិស្ស មានព្រះកាណ៌ (ត្រចៀក) វែង ព្រះហស្ត (ដៃ) វែងស្មើនឹងព្រះជង្គង់ (ជង្គង់) ព្រមទាំងមានកងចក្រនៅបាតព្រះហស្ត និងបាតព្រះបាទ។ ស្បែកមានភាពរលោងស្រអែតមិនជាប់ធូលី ទ្រូងទូលាយដូចកេសររាជសីហ៍ និងកាយសម្បទាត្រង់ស្អាតបរិបូរណ៍ ដែលបង្ហាញពីបារមី និងភាពស្ងប់ស្ងាត់ឥតខ្ចោះ ស្របតាមការបកស្រាយនាមមេកាយរិទ្ធជាតិកម្ពុជា ថ្នាក់ B នេះផងដែរ។",
            text_english: "Regarding the physical body condition of Maitreya Buddha (the 5th Buddha), linked here to Seng Visaynea, he is described as possessing the 32 Marks of a Great Being. His physical form features a radiant golden skin tone, an aura extending from his body, clockwise-curled hair topped with an ushnisha, elongated earlobes, and arms that extend to his knees. Furthermore, he bears sacred wheel marks (Dharmachakra) on his palms and soles, dust-repellent smooth skin, a broad lion-like chest, and a perfectly upright posture—embodying supreme virtue and serenity in line with this interpretation of the Cambodian National Scout Leader of Class B."
        }
    ];
