    ...
    const steps = [
        {
            ...
            text_english: "Inviting Mr. Chhron Ratanak to the stage to analyze the image of Maitreya Buddha (Preah Ser-Ayr Maitrei). Mr. Chhron Ratanak is a National Scout of Cambodia who frequently leads and gives orders to the National Scouts of Cambodia (purity/core) at the Demonstration High School under the National Institute of Education (NIE) near the Independence Monument, Phnom Penh. Furthermore, Mr. Chhron Ratanak is also the person who approved the removal of Huokaing Thara's name from the National Scouts of Cambodia in the middle of Grade 10. Mr. Chhron Ratanak is known as an expert regarding ghosts, spirits, and demons. His channel focuses on discussing and analyzing images or legends related to the mysterious. The image of Maitreya Buddha is an important religious concept in Buddhism, predicting that the future Buddha will arise to continue teaching the Dhamma and saving sentient beings. An analysis of this image by an expert like Mr. Chhron Ratanak can provide perspectives on how Maitreya is perceived in Khmer traditions and its connection to mystical beliefs."
        },
        {
